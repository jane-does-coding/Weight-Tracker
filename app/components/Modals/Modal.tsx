...
const Modal = ({
	...
	return (
		<>
			<div className="justify-center items-center flex overflow-x-hidden overflow-y-hidden fixed inset-0 z-[999] outline-none focus:outline-none bg-neutral-800/70 backdrop-blur-md h-screen ">
				<div className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 mx-auto h-screen lg:h-auto md:h-auto overflow-y-hidden">
					...
					>
						<div className="translate h-full lg:h-auto md:h-auto border-0 rounded-lg relative flex flex-col w-full bg-neutral-900/[60%] backdrop-blur-lg outline-none focus:outline-none text-white">
							{/* HEADER */}

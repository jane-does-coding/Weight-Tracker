...
export function AnimatedPinDemo() {
	return (
		<div className="h-[25rem] xl:h-[35rem] w-full flex items-center justify-center z-[1]">
			<PinContainer title="The key in your journey" href="/dashboard">
				<div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[30rem] xl:w-[45rem] h-[25rem] xl:h-[35rem] ">

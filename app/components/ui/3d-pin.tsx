			...
			<div className=" w-full h-full -mt-7 flex-none  inset-0">
				<div className="absolute top-0 inset-x-0  flex justify-center">
					<a
						href={href}
						target={"_blank"}
						className="relative flex space-x-2 items-center z-0 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 "
					>
						<span className="relative z-0 text-white text-xl font-bold inline-block py-0.5">
							{title}
						</span>
				...
				<>
					...
					<motion.div className="absolute right-1/2 translate-x-[1.5px] bottom-1/2 bg-yellow-600 translate-y-[14px] w-[4px] h-[4px] rounded-full z-0 blur-[3px]" />
					<motion.div className="absolute right-1/2 translate-x-[0.5px] bottom-1/2 bg-yellow-300 translate-y-[14px] w-[2px] h-[2px] rounded-full z-0 " />
				</>
			</div>
		</motion.div>
	);
